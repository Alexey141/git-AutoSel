	...
	<div id ="left">
		...
		<div id="right"><br>
			<center>
				...
				?>
				<div class="txtDelet">
					<p>Номер сотрудника: <?=$rt['id']?></p>
					<p>Имя: <?=$rt['Name']?></p>
					<p>Телефон: <?=$rt['phone']?></p>
				</div>
				
				<?php 
					echo "<a style='padding: 10px; color: #53DF00' href='deletwork2.php?id=$rt[id]'>Удалить</a>"; 
					echo " ";
					echo " ";
					echo " ";
					echo "<a style='color: red' href='workesEdit.php'>Не удалять</a>"
				?>
			</center>
		</div>	
  </body>
