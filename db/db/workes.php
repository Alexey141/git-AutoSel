 ...
 <body link="black" vlink="black" alink="black">
	<div id ="left">
		...
		<div id="right"><br>
			...
			<div class="product-item">
				<img src="https://randus.org/photos/m/c1dcdcc0c1e7e9c0.jpg">
				<div class="product-list">
				<center>
					<table>
						...
						<tr>
						<?php 
							$cont = mysqli_query($connect, "SELECT * FROM `workers` WHERE id = '3'");
							$cont = mysqli_fetch_all($cont);
							foreach ($cont as $conts) 
							{	
						?>
			...
			<div class="product-item">
				<img src="https://randus.org/photos/m/c399bd99ff3c1c38.jpg">
				<div class="product-list">
				<center>
					<table>
						...
						<tr>
						<?php 
							$cont = mysqli_query($connect, "SELECT * FROM `workers` WHERE id = '4'");
							$cont = mysqli_fetch_all($cont);
							foreach ($cont as $conts) 
							{	
						?>
