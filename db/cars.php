 ...
 <script>
	...
	<center>	
			...
			<div class="product-item">
				<img src="https://cdn.riastatic.com/photosnewr/auto/photo/mercedes-benz-g-55-amg__243881784-460x345.jpg">
				...
				<center>
					...
					<a href="car1.php" class="button">Подробнее</a>
				</div>
			</div>
			...
			<div class="product-item">
				<img src="https://s.auto.drom.ru/photo/Sw3ML8tjiaxFTG0FJOKWPqQMd0ympSThih74Ah_O_s7GtfkZilMc1_gwojRg9UG0S00ujKtaHuMkX2SYs9eBdR_BSMJE.jpg">
				<div class="product-list">
				<center>
					<table>
						...
						<tr>
						<?php 
							$cont = mysqli_query($connect, "SELECT * FROM `autoname` WHERE id_name = '3'");
							$cont = mysqli_fetch_all($cont);
							foreach ($cont as $conts) 
							{
						?>
			...
			<div class="product-item">
				<img src="https://s.auto.drom.ru/photo/IpnmjVYaCvwY8eMbsPs2fFIWTc-IrtHVrrDibR-pSYre6HQrpWsTtOvx4WrX-kO03BSOyn8iEV_BApJDpR4_x8N7e0qH.jpg">
				<div class="product-list">
				<center>
					<table>
						...
						<tr>
						<?php 
							$cont = mysqli_query($connect, "SELECT * FROM `autoname` WHERE id_name = '4'");
							$cont = mysqli_fetch_all($cont);
							foreach ($cont as $conts) 
							{
						?>
